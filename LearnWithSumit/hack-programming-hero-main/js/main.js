...
function markMileStone(checkbox, id) {
  ...
  if (checkbox.checked) {
    ...
    //reload(milestonesList);
     ...
     var allchild = milestonesList.childNodes;
     console.log(typeof allchild);
     ...
     arrItem.sort(function (a, b) {
      ...
      milestonesList.appendChild(logsss);
    })
...
// task - do the sorting
// reload list
// function reload(milestones){
//   const elements =  Array.from(milestones.children);
//   console.log(elements.id);
//   const sortIds = elements.map((element)=>{ return element.id}).sort((a,b)=>{return a-b});
  
//   for(id of sortIds){
//     const element = elements.find((el)=>{return el.id === id});
